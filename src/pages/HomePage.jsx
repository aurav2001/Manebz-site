...
const HomePage = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-white">
      ...
      {/* 4. INTERACTIVE COST CALCULATOR HERO TEASER BANNER */}
      <section className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-slate-950 via-gray-900 to-red-950 text-white rounded-3xl p-8 sm:p-12 shadow-2xl border border-red-900/30 flex flex-col lg:flex-row items-center justify-between gap-8 relative overflow-hidden">
          ...
          <div className="space-y-4 max-w-2xl relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-600/30 border border-red-500/40 text-red-300 text-xs font-bold uppercase tracking-wider">
              ...
              <span>Interactive ROI & Manpower Tool</span>
            </div>
            <h3 className="text-2xl sm:text-4xl font-black tracking-tight leading-tight">
              Estimate Your Facility & Staffing Budget in Real-Time
            </h3>
            <p className="text-sm text-gray-300 leading-relaxed font-normal">
              Select your facility square footage, manpower headcount, shift timings, and specialized equipment to calculate monthly costs with complete 100% PF/ESI statutory compliance breakups.
            </p>
            <div className="flex flex-wrap gap-4 pt-1 text-xs text-emerald-400 font-semibold">
              <span>✓ Instant PDF Quotation Summary</span>
              <span>✓ 18% - 24% Savings Estimator</span>
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col gap-3 shrink-0 w-full lg:w-auto relative z-10">
            <button
              ...
              className="px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-black text-xs sm:text-sm uppercase tracking-wider rounded-2xl shadow-xl shadow-red-600/30 flex items-center justify-center gap-2.5 transition-all cursor-pointer"
            >
            ...
            <button
              ...
              className="px-6 py-3.5 bg-white/10 hover:bg-white/20 text-white font-bold text-xs uppercase tracking-wider rounded-2xl border border-white/20 text-center transition-all cursor-pointer"
            >
              <span>Request Physical Site Audit</span>
            </button>
          </div>
        </div>
      </section>

      {/* 4.5 LATEST COMPLIANCE & FACILITY INSIGHTS (BLOG CMS) */}
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 mb-12">
            <div>
              ...
              <h2 className="text-2xl sm:text-4xl font-black text-slate-900 tracking-tight">
                Labour Law Updates & Facility Management Insights
              </h2>
              <p className="text-sm text-slate-600 mt-1 max-w-2xl">
                Stay compliant with expert guidelines from our legal counsel, facility directors, and payroll specialists.
              </p>
            </div>
            <button
              onClick={() => onNavigate('blog')}
              className="text-xs font-bold text-red-600 hover:text-red-700 uppercase tracking-wider flex items-center gap-1 shrink-0 cursor-pointer"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {blogs && blogs.slice(0, 3).map((post) => (
              <div
                ...
                className="bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-sm hover:shadow-xl hover:border-red-400 transition-all duration-300 flex flex-col justify-between cursor-pointer group"
              >
                <div>
                ...
                <div className="p-5 pt-0 flex items-center justify-between text-xs font-bold text-slate-400 border-t border-slate-100 mt-2">
