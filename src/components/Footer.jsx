        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 sm:gap-8 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <ul className="space-y-2.5 text-xs">
              ...
              <li>
                <button onClick={() => onNavigate('services')} className="hover:text-white transition-colors flex items-center gap-1.5 text-slate-300 font-medium cursor-pointer">
                  <span>All 5 Verticals</span>
                </button>
              </li>
              <li>
                <button onClick={() => onNavigate('payroll')} className="group hover:text-white transition-colors flex items-center gap-1.5 text-slate-300 font-bold cursor-pointer">
                  ...
                  <span className="text-[9px] font-black uppercase bg-red-500/20 text-red-400 border border-red-500/30 px-1.5 py-0.2 rounded">HOT</span>
                </button>
              </li>
              <li>
